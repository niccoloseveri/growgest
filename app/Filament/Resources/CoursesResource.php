        ...
        return $form
            ->schema([
                //
                    ...
                    Forms\Components\TextInput::make('partecipanti_previsti')->label('Partecipanti Previsti')->numeric()->maxLength(255),
                    Forms\Components\TextInput::make('ore_totali')->label('Durata (in ore)')->numeric(),
                    DatePicker::make('data_inizio')->label('Data Inizio Corso'),
                    DatePicker::make('data_fine')->label('Data Fine Corso'),
                    DatePicker::make('scadenza')->label('Scadenza Corso'),
                    ...
                    Forms\Components\TextInput::make('budget_lordo_cfe')->label('Budget Lordo CFE (€)')
                        ...
                        ->suffix('€')
                        ->maxLength(255),
                    Forms\Components\RichEditor::make('description')->label('Descrizione Corso')->maxLength(65535)->columnSpanFull(),
